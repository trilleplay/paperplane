...
class League_of_Legends(commands.Cog, name="League of Legends"):
    ...
    async def league(self, ctx, region: LeagueRegionConverter = None, *, username: LeagueUserConverter = None):
        ...
        embed = discord.Embed(title=f"Paperplane showing stats for League of Legends player: {await clean_escape(data['username'])}, on region: {await clean_escape(region['name'])}")
        ...
        embed.set_footer(text="paperplane isn’t endorsed by Riot Games and doesn’t reflect the views or opinions of Riot Games or anyone officially involved in producing or managing League of Legends. League of Legends and Riot Games are trademarks or registered trademarks of Riot Games, Inc. League of Legends © Riot Games, Inc.")
