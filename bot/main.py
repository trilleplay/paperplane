...
cogs = ["cogs.basic", "cogs.config", "cogs.gamestats.clash_royale", "cogs.gamestats.fortnite", "cogs.gamestats.League_of_Legends", "cogs.gamestats.Destiny", "cogs.gamestats.apex"]
